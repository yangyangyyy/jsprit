...
public class VehicleImplTest {
    ...
    @Test
    public void itShouldSetMaxOperationTime(){
        VehicleImpl v = VehicleImpl.Builder.newInstance("v").setStartLocationId("start")
                .setMaxOperationTime(300.).build();
        assertEquals(300.,v.getMaxOperationTime(),0.01);
    }
